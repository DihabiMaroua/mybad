...
1. Sauvegardez le script `badminton_booking_system.sql` localement, le fichier de la bdd `badminton_booking_system.sql` se trouve dans la racine du projet que vous avez téléchargé.
